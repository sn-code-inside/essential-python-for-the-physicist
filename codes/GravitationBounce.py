...
class CelBody:
  ...
  def draw(self,canvas,orig,nWake):
    if self.collide>0:
      canvas.create_oval(orig[0]+int(self.x-100),\
        int(orig[1]-self.y+100),int(orig[0]+self.x+100),\
          int(orig[1]-self.y-100),outline='yellow',fill='yellow')
      self.collide-=1
    canvas.create_oval(orig[0]+int(self.x-self.rad),\
      int(orig[1]-self.y+self.rad),int(orig[0]+self.x+self.rad),\
        int(orig[1]-self.y-self.rad),outline=self.col,fill=self.col)
    k=1
...
# ....................................................... root window
root=Tk()
root.title('Bouncing Gravitation')
