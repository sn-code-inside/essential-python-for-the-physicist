...
#
# .................................................. .......................
x=linspace(-xiMaxPlot,xiMaxPlot,(2*nPointsPlot)+1)
# ................................................................ draw grid
grid(True)
# ........................................................................
eigv=[]
...
while True:
  ...
  psi=[]
  eigv.append(SymmWell(params,xi,i,EigvStart,EigvStep,tolerance,dfdxi,psi))
  if eigv[i]>0:
    print(i,eigv[i])
  else:
    break
  ...
  while len(psi)>5:
    ...
    psi.pop()
  # ........................................................... normalize psi
  NormFact=sqrt(2.0*simps(square(psi),dx=DeltaXi,even='first'))
  ...
  plot([-xiMaxPlot,xiMaxPlot],[EnerShift,EnerShift],'black')
  plot(x,psi)
  # ........................................................ next eigenvalue
  EigvStart=eigv[i]+EigvStep
  i+=1
# ......................................................... plot square well
plot([-xiMaxPlot,-xi0],[1.0,1.0],color='black')
plot([-xi0,-xi0],[1.0,0.0],color='black')
plot([xi0,xi0],[0.0,1.0],color='black')
plot([xi0,xiMaxPlot],[1.0,1.0],color='black')
ylim(0.0,1.1)
plt.ylabel('Energy/$V_0$',fontsize=18)
plt.xlabel('$x\\,\\frac{\\sqrt{2mV_0}}{\\hbar}$',fontsize=24)
plt.tight_layout()
# --------------------------------------------------------------------------
plt.savefig('SquareWell00.eps', format='eps', dpi=1000)
show() # show the plot
