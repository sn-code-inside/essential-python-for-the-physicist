...
cx=(pt1.m*pt1.x+pt2.m*pt2.x)/(pt1.m+pt2.m)
cy=(pt1.m*pt1.y+pt2.m*pt2.y)/(pt1.m+pt2.m)
print('momentum1 = ({:.1f},{:.1f})'.format(pt1.px,pt1.py))
print('momentum2 = ({:.1f},{:.1f})'.format(pt2.px,pt2.py))
print('center of mass = ({:.3f},{:.3f})'.format(cx,cy))
...
print('particle.__dict__:',particle.__dict__)
